...
parser.add_argument('-b', help='cooler binsize', type=int, required=True)
...
def main():
    ...
    path_uri = args.i + "::/resolutions/" + str(args.b)
    ...
    cfname = '.'.join(cfname.split(".")[:-2])
    OUT_fname = cfname + "." + str(args.b) + '_range' + str(int(2*grange/1000000)) + 'Mb_cispercent.bedGraph'
